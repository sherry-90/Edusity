            ...
            <ul ref={slider}>
                <li>
                    <div className="slide">
                        ...
                        <p>Choosing to pursue my degree at Edusity was one of the best decision I have ever made. The supportive community, state of the art facilities and commitment to academic execellence have truly exceeded my expectations.</p>
                    </div>
                </li>
                  <li>
                    <div className="slide">
